<div class="container main">   
  	<div class="page-header">
	    ...
	    <div class="well">			
			<p>Nessa área o elaborador irá criar as propostas para que elas sejam analisadas pelo aprovador, após criação da mesma.</p>
		</div>
	...
	<div class="container">
		<form action="" method="post" class="form-horizontal">
			...
			<!-- Form Name -->
			<legend>Criar nova proposta</legend>
			...
			<div class="form-group">
			  ...
			  <div class="col-md-4">
			    <select id="selectmultiple" name="servicos_id[]" class="form-control" multiple="multiple">			      
			      <?php 
			      	$cont = 0;
			      	foreach ($query_servicos as $key => $value): 
